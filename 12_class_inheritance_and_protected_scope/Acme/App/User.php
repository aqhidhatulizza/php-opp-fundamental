...
class User
{
     ...
     * @var array
     */
    protected $accesible = array('email', 'password');
    ...
    /**
     * Directly set innaccessible but existing propertie, if in $this->fillable array
     * @param string $name
     * @param string $value
     * @return void
     */
...
/** Directly get inaccessible  but existing properties,if in $this->accessible array
 * @param string $name
 * @return mixed
 */
