...
private $errors = array();
    ...
    /**
     * Validate data against a set of rules and set  of rules and errors in the $this->errors
     * array
     * @param array $rules
     * @return boolean
     */
    ...
    foreach ($rules as $item => $ruleset) {
        ...
        foreach ($ruleset as $rule) {
            ...
            $pos = (strpos ($rule, ':');
                ...
                $methodName = 'validate' . ucifirst($rule);
    ...
    public function getErrors ()
{
    ...
    /**
     * Validation the $value of $item to see if it is present and not empty
     * @param string $item
     * @param string $value
